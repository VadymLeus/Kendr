...
const SiteDashboardPage = () => {
    ...
    const [collapsedBlocks, setCollapsedBlocks] = useState(() => {
        try {
            const saved = localStorage.getItem(`collapsed_blocks_${site_path}_${currentPageId}`);
    ...
    useEffect(() => {
        if (site_path && currentPageId) {
            localStorage.setItem(
                `collapsed_blocks_${site_path}_${currentPageId}`, 
    ...
    const handleSiteDataUpdate = (newData) => {w
