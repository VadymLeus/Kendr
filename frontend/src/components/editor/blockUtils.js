// frontend/src/components/editor/blockUtils.js
import { produce } from 'immer';
import { get, set, unset } from 'lodash';

// Отримує шлях у форматі для lodash
const getPathString = (path) => path.join('.');

// Знаходить блок за шляхом
export const findBlockByPath = (blocks, path) => {
    return get(blocks, getPathString(path), null);
};

// Оновлює дані блоку за шляхом
