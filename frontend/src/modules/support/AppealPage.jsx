                ...
                {suspendedSites.map(site => {
                    ...
                    return (
                        <div key={site.id} className="bg-(--platform-card-bg) border border-(--platform-border-color) rounded-xl p-6 shadow-sm flex flex-col gap-4 transition-shadow hover:shadow-md">
                            ...
                            {siteReason && (
                                <div className="bg-[color-mix(in_srgb,var(--platform-danger),transparent_90%)] text-[color-mix(in_srgb,var(--platform-danger),black_20%)] dark:text-[color-mix(in_srgb,var(--platform-danger),white_20%)] p-4 rounded-lg text-sm flex items-start md:items-center gap-3 border border-[color-mix(in_srgb,var(--platform-danger),transparent_80%)]">
                                    <Ban size={24} className="shrink-0 text-(--platform-danger)" />
